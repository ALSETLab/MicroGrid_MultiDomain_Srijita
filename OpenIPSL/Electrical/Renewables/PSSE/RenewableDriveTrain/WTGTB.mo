...
model WTGTB
  ...
  extends
    OpenIPSL.Electrical.Renewables.PSSE.RenewableDriveTrain.BaseClasses.BaseRenewableDriveTrain2;
  ...
  NonElectrical.Continuous.SimpleLag simpleLag(K=1, T=Tp,
    y_start=p00)
    annotation (Placement(transformation(extent={{-116,-14},{-96,6}})));
  parameter Types.Time Tp=0.5 "Power sensor time-delay constant";
protected
...
equation
  ...
  connect(wg, add4.y) annotation (Line(points={{130,-60},{110,-60},{110,-46},
          {85,-46}}, color={0,0,127}));
  connect(simpleLag.u, Pe) annotation (Line(points={{-118,-4},{-140,-4},{-140,-60}},
        color={0,0,127}));
  connect(simpleLag.y, division.u1) annotation (Line(points={{-95,-4},{-94,-4},{
          -94,40},{-118,40},{-118,60},{-112,60}}, color={0,0,127}));
