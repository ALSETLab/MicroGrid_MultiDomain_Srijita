...
equation
  ...
  connect(PlantController.Plant_pref, RenewableGenerator.p_0) annotation (Line(
        ...
        color={0,0,127}));
  connect(PlantController.Qref, RenewableGenerator.q_0) annotation (Line(points={{-80,11},{-98,11},{-98,-98},{58.5714,-98},{58.5714,-21.4286}},
                                                                         color={
          0,0,127}));
  ...
  connect(RenewableGenerator.V_t, RenewableController.Vt) annotation (Line(
        points={{37.1429,21.4286},{37.1429,28},{-28,28},{-28,13.3333},{-23.3333,13.3333}},
                     color={0,0,127}));
  ...
  connect(RenewableGenerator.Qgen, RenewableController.Qgen) annotation (Line(
        points={{62.8571,21.4286},{62.8571,32},{-32,32},{-32,2.66667},{-23.3333,2.66667}},
                     color={0,0,127}));
  ...
  connect(RenewableGenerator.IQ0, RenewableController.iq0) annotation (Line(
        points={{32.8571,-21.4286},{32.8571,-26},{13.3333,-26},{13.3333,-21.3333}},
        color={0,0,127}));
  ...
  connect(RenewableController.p0, RenewableGenerator.p_0) annotation (Line(
        points={{-17.3333,-21.3333},{-17.3333,-34},{67.1429,-34},{67.1429,-21.4286}},
        color={0,0,127}));
  connect(gain.y, RenewableController.Pref) annotation (Line(points={{37.4,-44},{-28,-44},{-28,-8},{-23.3333,-8}},
                                             color={0,0,127}));
  connect(gain1.y, RenewableController.Qext) annotation (Line(points={{37.4,-64},{-30,-64},{-30,-2.66667},{-23.3333,-2.66667}},
                                                         color={0,0,127}));
  ...
  connect(PlantController.q0, RenewableController.q0) annotation (Line(points={{-46,-22},{-46,-32},{-10,-32},{-10,-21.3333}},
                                                        color={0,0,127}));
  connect(PlantController.v0, RenewableController.v0) annotation (Line(points={{-58,-22},{-58,-30},{-2,-30},{-2,-21.3333}},
                                                      color={0,0,127}));
  connect(PlantController.p0, RenewableController.p0) annotation (Line(points={{-70,-22},{-70,-34},{-17.3333,-34},{-17.3333,-21.3333}},
                                                                  color={0,0,127}));
  connect(DriveTrain.wg, RenewableController.Wg) annotation (Line(points={{-51.1667,-75},{-32,-75},{-32,-13.3333},{-23.3333,-13.3333}},
                                                              color={0,0,127}));
