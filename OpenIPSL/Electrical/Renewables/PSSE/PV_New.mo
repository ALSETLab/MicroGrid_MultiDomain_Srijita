...
extends OpenIPSL.Electrical.Essentials.pfComponent(
  ...
  replaceable RenewableGeneratorConverter.BaseClasses.baseRenewableGenerator
    RenewableGenerator(
    P_0=P_0,
    Q_0=Q_0,
    v_0=v_0,
...
equation
  ...
  connect(RenewableGenerator.V_t, RenewableController.Vt) annotation (Line(
        points={{33.7143,21.4286},{33.7143,26},{-26,26},{-26,15.975},{-22.9189,
  ...
  connect(RenewableGenerator.Pgen, RenewableController.Pe) annotation (Line(
        points={{55.7143,21.4286},{55.7143,32},{-30,32},{-30,6.8625},{-22.9189,
          6.8625}}, color={0,0,127}));
  connect(RenewableGenerator.Qgen, RenewableController.Qgen) annotation (Line(
        points={{62.8571,21.4286},{62.8571,36},{-32,36},{-32,2.1375},{-22.9189,
  ...
  connect(RenewableGenerator.IP0, RenewableController.ip0) annotation (Line(
        points={{39.4286,-21.4286},{39.4286,-28},{3.72973,-28},{3.72973,-19.125}},
        color={0,0,127}));
  connect(RenewableGenerator.V_0, RenewableController.v0) annotation (Line(
        points={{46.8571,-21.4286},{46.8571,-32},{-1.78378,-32},{-1.78378,
          -19.125}}, color={0,0,127}));
  connect(PlantController.v0, RenewableGenerator.V_0) annotation (Line(points={
          {-62,-22},{-62,-32},{46.8571,-32},{46.8571,-21.4286}}, color={0,0,127}));
  connect(RenewableController.q0, RenewableGenerator.q_0) annotation (Line(
        points={{-7.2973,-19.125},{-7.2973,-34},{61.4286,-34},{61.4286,-21.4286},
          {61.4286,-21.4286}}, color={0,0,127}));
  connect(PlantController.q0, RenewableGenerator.q_0) annotation (Line(points={
          {-50,-22},{-50,-34},{61.4286,-34},{61.4286,-21.4286}}, color={0,0,127}));
  ...
  connect(RenewableController.i0, RenewableGenerator.I_0) annotation (Line(
        points={{0.972973,-19.0125},{0.972973,-30},{52.5714,-30},{52.5714,
