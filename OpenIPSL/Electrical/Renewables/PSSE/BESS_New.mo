...
extends OpenIPSL.Electrical.Essentials.pfComponent(
  ...
  replaceable OpenIPSL.Electrical.Renewables.PSSE.RenewableGeneratorConverter.BaseClasses.baseRenewableGenerator
    ...
    annotation (choicesAllMatching=true,Placement(transformation(extent={{30,-20},
            {70,20}})));
  replaceable
    RenewableElectricalController.BaseClasses.BaseREECD
    RenewableController(
    pfflag=pfflag,
    vflag=vflag,
    qflag=qflag,
  ...
  Modelica.Blocks.Interfaces.RealInput regulate_vi if QFunctionality >= 4
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={60,86})));
  Modelica.Blocks.Sources.Constant WG(k=0) annotation (Placement(transformation(extent={{-60,-64},{-50,-54}})));
protected
...
equation
  ...
  connect(PlantController.Pref, RenewableController.Pref) annotation (Line(
        points={{-37,-10},{-34,-10},{-34,-6},{-24,-6},{-24,-7.5},{-21.0811,-7.5}},
                                                                         color={
          0,0,127}));
  connect(PlantController.p0, RenewableController.p0) annotation (Line(points={{-70,-22},{-70,-44},{-8.64865,-44},{-8.64865,-21.25}},
                                                                  color={0,0,127}));
  connect(PlantController.v0, RenewableController.v0) annotation (Line(points={{-58,-22},{-58,-36},{3.78378,-36},{3.78378,-21.25}},
                                                    color={0,0,127}));
  connect(PlantController.q0, RenewableController.q0) annotation (Line(points={{-46,-22},{-46,-40},{-2.7027,-40},{-2.7027,-21.25}},
                                                      color={0,0,127}));
  ...
  connect(gain1.y, RenewableController.Qext) annotation (Line(points={{-12.6,
          -80},{-32,-80},{-32,-2.625},{-21.0811,-2.625}},color={0,0,127}));
  ...
  connect(PAUX.y, RenewableController.Paux) annotation (Line(points={{-69.5,-75},
          {-69.5,-76},{-28,-76},{-28,-16.625},{-21.0811,-16.625}},                                                                        color={0,0,127}));
  connect(WG.y, RenewableController.Wg) annotation (Line(points={{-49.5,-59},{
          -49.5,-60},{-30,-60},{-30,-12.25},{-21.0811,-12.25}},                                                                     color={0,0,127}));
  connect(RenewableController.It, RenewableGenerator.I_t) annotation (Line(points={{
          -21.0811,12.875},{-32,12.875},{-32,40},{41.4286,40},{41.4286,21.4286}},                                                                           color={0,0,127}));
