...
model Wind_plant_WithPC "Wind source in a SMIB system to test functionality of REECCA electrical controller model"
  extends BaseClasses.SMIBRenewable;
  Electrical.Renewables.PSSE.Wind_New wind_SRIJITA(
    P_0=1500000,
    Q_0=-5665800,
    v_0=1,
    angle_0=0.02574992,
...
equation
  connect(wind_SRIJITA.pwPin, GEN1.p) annotation (Line(points={{-40,0},{-30,0}}, color={0,0,255}));
  connect(freq.y, wind_SRIJITA.FREQ) annotation (Line(points={{-75,0},{-60.6,0}}, color={0,0,127}));
  connect(wind_SRIJITA.regulate_vi, pwVoltage.vi) annotation (Line(points={{-44,8.6},{-44,30},{-36.6,30}}, color={0,0,127}));
  connect(pwVoltage.vr, wind_SRIJITA.regulate_vr) annotation (Line(points={{-36.6,33.6},{-56,33.6},{-56,8.6}}, color={0,0,127}));
  connect(wind_SRIJITA.branch_ir, pwCurrent.ir) annotation (Line(points={{-44,-8.6},{-44,-16},{-17.6,-16},{-17.6,-6.6}}, color={0,0,127}));
  connect(pwCurrent.ii, wind_SRIJITA.branch_ii) annotation (Line(points={{-14,-6.6},{-14,-20},{-56,-20},{-56,-8.6}}, color={0,0,127}));
