...
model BESS_plant_WithPC "BESS source in a SMIB system to test functionality of REPCA plant controller model"
  extends BaseClasses.SMIBRenewable(pwFault(t2=2.5));
  Electrical.Renewables.PSSE.BESS_New bESS_Srijita(
    fn=SysData.fn,
    P_0=1500000,
    Q_0=-5665800,
    v_0=1,
...
equation
  connect(freq.y, bESS_Srijita.FREQ) annotation (Line(points={{-75,0},{-60.6,0}}, color={0,0,127}));
  connect(bESS_Srijita.pwPin, GEN1.p) annotation (Line(points={{-40,0},{-30,0}}, color={0,0,255}));
  connect(pwCurrent.ir, bESS_Srijita.branch_ir) annotation (Line(points={{-17.6,-6.6},{-17.6,-16},{-44,-16},{-44,-8.6}}, color={0,0,127}));
  connect(pwCurrent.ii, bESS_Srijita.branch_ii) annotation (Line(points={{-14,-6.6},{-14,-20},{-56,-20},{-56,-8.6}}, color={0,0,127}));
  connect(pwVoltage.vi, bESS_Srijita.regulate_vi) annotation (Line(points={{-36.6,30},{-44,30},{-44,8.6}}, color={0,0,127}));
  connect(pwVoltage.vr, bESS_Srijita.regulate_vr) annotation (Line(points={{-36.6,33.6},{-56,33.6},{-56,8.6}}, color={0,0,127}));
  annotation (experiment(
      StopTime=5,
      __Dymola_NumberOfIntervals=10004,
      __Dymola_Algorithm="Rkfix2"),                               Documentation(
        info="<html>
<p>
